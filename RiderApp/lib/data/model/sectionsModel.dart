import 'package:erestro_single_vender_rider/data/model/attributesModel.dart';
import 'package:erestro_single_vender_rider/data/model/filtersModel.dart';
import 'package:erestro_single_vender_rider/data/model/minMaxPriceModel.dart';
import 'package:erestro_single_vender_rider/data/model/productAddOnsModel.dart';
import 'package:erestro_single_vender_rider/data/model/reviewImagesModel.dart';
import 'package:erestro_single_vender_rider/data/model/variantAttributesModel.dart';
import 'package:erestro_single_vender_rider/data/model/variantsModel.dart';
...
class SectionsModel {
  ...
  SectionsModel.fromJson(Map<String, dynamic> json) {
    ...
    productTags = json['product_tags'] == null
        ? List<String>.from([])
        : (json['product_tags'] as List).map((e) => e.toString()).toList();
    partnerTags = json['partner_tags'] == null
        ? List<String>.from([])
        : (json['partner_tags'] as List).map((e) => e.toString()).toList();
...
class ProductDetails {
  ...
  ProductDetails.fromJson(Map<String, dynamic> json) {
    ...
    otherImagesRelativePath = json['other_images_relative_path'] == null
        ? List<String>.from([])
        : (json['other_images_relative_path'] as List)
            .map((e) => e.toString())
            .toList();
