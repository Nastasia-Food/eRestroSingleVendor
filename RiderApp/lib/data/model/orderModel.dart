...
import 'package:erestro_single_vender_rider/data/model/branchModel.dart';
...
class OrderModel {
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    riderCancelOrder = json['rider_cancel_order'];
    ...
    branchDetails = json['branch_details'] != null ? new BranchModel.fromJson(json['branch_details']) : null;
  }
}
