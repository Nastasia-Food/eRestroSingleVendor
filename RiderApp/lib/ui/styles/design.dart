...
class DesignConfig {
  ...
  static InputDecoration inputDecorationextField(String lableText, String hintText, double width, BuildContext context,
      {bool? status = false, Widget passwordWidget = const SizedBox.shrink(), Widget prefixWidget = const SizedBox.shrink()}) {
  ...
  static InputDecoration inputDecorationextIconField(String lableText, String hintText, double width, BuildContext context,
      {bool? status = false, Widget passwordWidget = const SizedBox.shrink(), Widget prefixWidget = const SizedBox.shrink()}) {
    return InputDecoration(
      labelText: lableText,
      fillColor: textFieldBackground,
  ...
  static appBar(BuildContext context, double? width, String? text, bottom,
      {bool? status = false, double? preferSize = kToolbarHeight, String? from = "", String? latitude = "", longitude = ""}) {
  ...
  static appBarWihoutBackbutton(BuildContext context, double? width, String? text, bottom,
      {preferSize = kToolbarHeight, Widget? actionBar = const SizedBox.shrink()}) {
    return PreferredSize(
      preferredSize: Size.fromHeight(preferSize),
      child: Container(
        decoration: BoxDecoration(boxShadow: [
  ...
  static TextButton bottomBarTextButton(
      BuildContext context, int selectedIndex, int index, void Function() onPressed, String? activeIcon, String? inactiveIcon, String? iconTitle) {
    return TextButton(
      child: Column(
