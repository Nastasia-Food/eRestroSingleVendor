                          ...
                          child: BlocConsumer<UpdateUserDetailCubit, UpdateUserDetailState>(
                              ...
                              builder: (context, state) {
                                return SmallButtonContainer(
                                    ...
                                    height: widget.height,
                                    width: widget.width,
                                    text: context.read<AuthCubit>().getStatus() == "1"
                                    ...
                                    onTap: () {
                                      print(
                                          "status:${context.read<AuthCubit>().getStatus()}--${context.read<AuthCubit>().getStatus() == "1" ? "0" : "1"}");
                                      context.read<UpdateUserDetailCubit>().updateProfile(
                                          ...
                                          status: context.read<AuthCubit>().getStatus() == "1" ? "0" : "1");
                                    });
                              }),
                        )
            ],
