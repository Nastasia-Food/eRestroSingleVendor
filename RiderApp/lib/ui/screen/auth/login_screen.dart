...
class LoginScreenState extends State<LoginScreen> {
  ...
  TextEditingController phoneNumberController = TextEditingController(text: "9987654321");
          ...
          : Scaffold(
              ...
              bottomNavigationBar: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(UiUtils.getTranslatedLabel(context, byContinuingYouAgreeToOurLabel),
                        style: TextStyle(
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                      GestureDetector(
                        ...
                        child: Text("${UiUtils.getTranslatedLabel(context, termAndConditionLabel)} ",
                            style: TextStyle(
                                decoration: TextDecoration.none,
                      ...
                      Text("${UiUtils.getTranslatedLabel(context, andLabel)} ",
                          style: TextStyle(
                              decoration: TextDecoration.none,
                              color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.76),
                              fontSize: 14.0,
                      ...
                      GestureDetector(
                        ...
                        child: Text(UiUtils.getTranslatedLabel(context, privacyPolicyLabel),
                            style: TextStyle(
                                decoration: TextDecoration.none,
                                color: Theme.of(context).colorScheme.secondary,
                                fontSize: 14.0,
                  ...
                  SliverFillRemaining(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      Stack(
                        ...
                        children: <Widget>[
                          SvgPicture.asset(DesignConfig.setSvgPath("rider_login")),
                          Container(color: Theme.of(context).colorScheme.primary.withOpacity(0.12), height: height / 2.5),
                        ],
                      ),
                      ...
                      Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: DesignConfig.inputDecorationextIconField(UiUtils.getTranslatedLabel(context, phoneNumberLabel),
                                UiUtils.getTranslatedLabel(context, enterPhoneNumberLabel), width, context,
                                prefixWidget: Icon(Icons.call_outlined, color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.76))),
                      ...
                      Container(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor: Theme.of(context).colorScheme.onPrimary.withOpacity(0.76),
                            obscureText: obscure,
                            decoration: DesignConfig.inputDecorationextIconField(UiUtils.getTranslatedLabel(context, passwordLabel),
                                UiUtils.getTranslatedLabel(context, enterPasswordLabel), width, context,
                                status: true,
                                passwordWidget: GestureDetector(
                                    ...
                                    child: Icon(obscure == true ? Icons.visibility_off : Icons.visibility,
                                        color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.76))),
                                prefixWidget: Icon(Icons.lock_outline, color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.76))),
                      ...
                      GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: Align(
                            ...
                            child: Text(UiUtils.getTranslatedLabel(context, forgotPasswordLabel), textAlign: TextAlign.end,
                                style: TextStyle(fontSize: 16, color: Theme.of(context).colorScheme.secondary, fontWeight: FontWeight.w700)),
                          ),
                        ),
                      ),
                      BlocConsumer<SignInCubit, SignInState>(
                        listener: (context, state) {
                          if (state is SignInFailure) {
                            ...
                            status = false;
                            Future.delayed(
                                Duration.zero, () => Navigator.of(context).pushNamedAndRemoveUntil(Routes.home, (Route<dynamic> route) => false));
                          }
                        },
                        builder: (context, state) {
                          return Container(
                            padding: EdgeInsetsDirectional.only(start: width / 20.0, top: height / 99.0, end: width / 20.0),
                            child: SizedBox(
                              width: width,
                              child: ButtonContainer(
                                ...
                                onPressed: () {
                                  if (phoneNumberController.text.isEmpty) {
                                    ...
                                    UiUtils.setSnackBar(UiUtils.getTranslatedLabel(context, enterPasswordLabel), context, false, type: "2");
                                    status = false;
                                  } else {
