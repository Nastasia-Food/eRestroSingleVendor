                                            ...
                                            BlocBuilder<GetRiderDetailCubit, GetRiderDetailState>(
                                                ...
                                                builder: (context, state) {
                                                  if (state is GetRiderDetailFetchSuccess) {
                                                    return Text(
                                                      "${context.read<SystemConfigCubit>().getCurrency()}${double.parse(state.authModel.cashReceived.toString()).toStringAsFixed(2)}", //${double.parse(state.riderCashCollectionList[0].cashReceived!).toStringAsFixed(2)}",
                                                      style: const TextStyle(
                                                          color: Colors.white,
                                                          fontWeight: FontWeight.w600,
                                                          fontStyle: FontStyle.normal,
