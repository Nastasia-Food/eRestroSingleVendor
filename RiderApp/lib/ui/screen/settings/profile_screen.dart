                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                          ...
                          width: 50,
                          decoration:
                              DesignConfig.boxDecorationContainerBorder(commentBoxBorderColor, Theme.of(context).colorScheme.onSurface, 100.0),
                          child: Icon(
                            Icons.photo_library,
                                ...
                                BlocConsumer<UpdateUserDetailCubit, UpdateUserDetailState>(
                                    ...
                                    listener: (context, state) {
                                      ...
                                      if (state is UpdateUserDetailSuccess) {
                                        ...
                                        context.read<AuthCubit>().updateUserEmail(emailController.text);
                                        context.read<AuthCubit>().updateUserMobile(phoneNumberController.text);
                                        context.read<AuthCubit>().updateUserAddress(addressController.text);
