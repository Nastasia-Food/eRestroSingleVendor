    ...
    return InkWell(
      ...
      child: ListTile(
        ...
        trailing: IconButton(
            ...
            icon: Icon(Icons.arrow_forward_ios, size: 12, color: Theme.of(context).colorScheme.onSecondary)),
      ),
    );
  }
    ...
    return arrowTile(
        ...
        onPressed: () {
          Navigator.of(context)
              .pushNamed(Routes.changePassword, arguments: {"from": "change", "mobileNumber": context.read<AuthCubit>().getMobile()});
        });
  }
                        ...
                        children: [
                          Container(
                              ...
                              child: Text(
                                  ...
                                  style: TextStyle(fontSize: 16, color: Theme.of(context).colorScheme.onPrimary, fontWeight: FontWeight.w700))),
                          Expanded(
                            child: Column(
                                mainAxisSize: MainAxisSize.min,
                                mainAxisAlignment: MainAxisAlignment.start,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(UiUtils.getTranslatedLabel(context, noteLabel),
                                      style: TextStyle(fontSize: 14, color: Theme.of(context).colorScheme.error, fontWeight: FontWeight.w600)),
                                  const SizedBox(height: 4.0),
                                  Text(UiUtils.capitalize(state.authModel.commissionMethod!).toString().replaceAll("_", " "),
                                      style: TextStyle(
                                          fontSize: 14,
            ...
            Container(
                ...
                child: Column(children: [
                  ...
                  (context.read<AuthCubit>().state is AuthInitial ||
                              context.read<AuthCubit>().state is Unauthenticated) || (context.read<SystemConfigCubit>().getDemoMode() == "0") ||
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              appBar: DesignConfig.appBarWihoutBackbutton(context, width, UiUtils.getTranslatedLabel(context, myProfileLabel),
