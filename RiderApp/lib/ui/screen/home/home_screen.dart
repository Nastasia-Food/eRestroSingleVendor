...
class HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Widget statasticCard(String? icon, String? title, String? total) {
    return Container(
        height: 130,
        width: 166.5,
        decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.primary.withOpacity(0.11), 8.0),
            ...
            children: [
              Container(
                  decoration: DesignConfig.boxDecorationContainerCardShadow(
                      Theme.of(context).colorScheme.secondary, Theme.of(context).colorScheme.secondary.withOpacity(0.11), 4.0, 0, 2, 10, 0),
                  padding: EdgeInsetsDirectional.all(5.0),
                  child: SvgPicture.asset(DesignConfig.setSvgPath(icon!))),
              const SizedBox(height: 10.0),
              Text(title!,
                  style: TextStyle(fontSize: 16, color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.76), fontWeight: FontWeight.w500)),
                        ...
                        child: Row(
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                    getRiderDetailState.authModel.active == "1"
                                ...
                                InkWell(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: getRiderDetailState.authModel.active == "1"
                                          ? Theme.of(context).colorScheme.onSurface
                                          : Theme.of(context).colorScheme.onSurface,
                                    ),
                                    child: AnimatedAlign(
                                      duration: const Duration(milliseconds: 300),
                                      alignment: getRiderDetailState.authModel.active == "1" ? Alignment.centerRight : Alignment.centerLeft,
                                      curve: Curves.decelerate,
                                      child: Padding(
                                        padding: EdgeInsets.all(getRiderDetailState.authModel.active == "1" ? 2.0 : 5.0),
                                        child: getRiderDetailState.authModel.active == "1"
                                    ...
                                    showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          return CustomDialog(
                                              ...
                                              subtitle: getRiderDetailState.authModel.active == "1"
                    ...
                    Row(children: [
                      Expanded(
                          child: statasticCard("total_earning", UiUtils.getTranslatedLabel(context, totalEarningLabel),
                              "${context.read<SystemConfigCubit>().getCurrency()}${getRiderDetailState.authModel.balance}")),
                      Expanded(
                                                    ...
                                                    children: [
                                                      SvgPicture.asset(DesignConfig.setSvgPath("pro_date"),
                                                          ...
                                                          colorFilter: ColorFilter.mode(
                                                              Theme.of(context).colorScheme.onPrimary.withOpacity(0.76), BlendMode.srcIn)),
                                                      const SizedBox(
                                                        width: 5.0,
                                                      ),
