...
class SystemConfigCubit extends Cubit<SystemConfigState> {
  ...
  getSystemConfig() {
    ...
    _systemConfigRepository.getSystemConfig().then((value) => emit(SystemConfigFetchSuccess(systemConfigModel: value))).catchError((e) {
  ...
  String getCurrency() {
    if (state is SystemConfigFetchSuccess) {
      return (state as SystemConfigFetchSuccess).systemConfigModel.data!.systemSettings!.currency!;
    }
    return "";
  }
  ...
  String getIsReferEarnOn() {
    if (state is SystemConfigFetchSuccess) {
      return (state as SystemConfigFetchSuccess).systemConfigModel.data!.systemSettings!.isReferEarnOn!;
    }
    return "";
  }
  ...
  String getCurrentVersionAndroid() {
    if (state is SystemConfigFetchSuccess) {
      return (state as SystemConfigFetchSuccess).systemConfigModel.data!.systemSettings!.currentVersion!;
    }
    return "";
  }
  ...
  String getCurrentVersionIos() {
    if (state is SystemConfigFetchSuccess) {
      return (state as SystemConfigFetchSuccess).systemConfigModel.data!.systemSettings!.currentVersionIos!;
    }
    return "";
  }
  ...
  String isForceUpdateEnable() {
    if (state is SystemConfigFetchSuccess) {
      return (state as SystemConfigFetchSuccess).systemConfigModel.data!.systemSettings!.isVersionSystemOn!;
    }
    return "";
  }
  ...
  String isAppMaintenance() {
    if (state is SystemConfigFetchSuccess) {
      return (state as SystemConfigFetchSuccess).systemConfigModel.data!.systemSettings!.isRiderAppMaintenanceModeOn!;
    }
    return "";
  }
  ...
  String getIsRiderOtpSettingOn() {
    if (state is SystemConfigFetchSuccess) {
      return (state as SystemConfigFetchSuccess).systemConfigModel.data!.systemSettings!.isRiderOtpSettingOn!;
    }
    return "";
  }
  ...
  String getAuthenticationMethod() {
    if (state is SystemConfigFetchSuccess) {
      return (state as SystemConfigFetchSuccess).systemConfigModel.data!.authenticationMode.toString();
    }
    return "0";
  }
}
