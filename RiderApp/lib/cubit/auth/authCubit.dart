...
class AuthCubit extends Cubit<AuthState> {
  ...
  String getCompleteDelivery() {
    if (state is Authenticated) {
      return (state as Authenticated).authModel.completeDelivery!;
    }
    return "";
  }
  ...
  String getCancelDelivery() {
    if (state is Authenticated) {
      return (state as Authenticated).authModel.cancelDelivery!;
    }
    return "";
  }
  ...
  String getPendingDeivery() {
    if (state is Authenticated) {
      return (state as Authenticated).authModel.pendingDeivery!;
    }
    return "";
  }
  ...
  String getBalance() {
    if (state is Authenticated) {
      return (state as Authenticated).authModel.balance!;
    }
    return "";
  }
  ...
  String getCommission() {
    if (state is Authenticated) {
      return (state as Authenticated).authModel.commission!;
    }
    return "";
  }

  String getCommissionMethod() {
    if (state is Authenticated) {
      return (state as Authenticated).authModel.commissionMethod!;
    }
    return "";
  }
