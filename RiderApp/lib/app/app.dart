  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      providers: [
        ...
        BlocProvider<AppLocalizationCubit>(create: (_) => AppLocalizationCubit(SettingsRepository())),
        ...
        BlocProvider<ManageLiveTrackingCubit>(create: (_) => ManageLiveTrackingCubit(OrderRepository())),
        ...
        BlocProvider<RiderCashCollectionCubit>(create: (_) => RiderCashCollectionCubit()),
        BlocProvider<RiderCashCubit>(create: (_) => RiderCashCubit()),
        BlocProvider<GetFundTransfersCubit>(create: (_) => GetFundTransfersCubit()),
        BlocProvider<SendWithdrawRequestCubit>(create: (_) => SendWithdrawRequestCubit(TransactionRepository())),
        BlocProvider<GetRiderDetailCubit>(create: (_) => GetRiderDetailCubit(ProfileManagementRepository())),
        ...
        BlocProvider<UpdateOrderRequestCubit>(create: (_) => UpdateOrderRequestCubit(OrderRepository())),
        BlocProvider<UpdateOrderStatusCubit>(create: (_) => UpdateOrderStatusCubit(OrderRepository())),
        BlocProvider<DeleteLiveTrackingCubit>(create: (_) => DeleteLiveTrackingCubit(OrderRepository())),
        BlocProvider<VerifyOtpCubit>(create: (_) => VerifyOtpCubit(AuthRepository())),
        BlocProvider<ResendOtpCubit>(create: (_) => ResendOtpCubit(AuthRepository())),
      ],
      child: Builder(
        builder: (context) {
