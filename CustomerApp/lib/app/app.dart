...
Future<Widget> initializeApp() async {
  ...
  await Hive.openBox(placeSearchAddressBox); //placeSearchAddress box for storing all placeSearchAddress details
  await Hive.openBox(searchProductKeyWordsBox); //searchAddress box for storing all searchAddress details
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      providers: [
        ...
        BlocProvider<TopRatedProductCubit>(create: (_) => TopRatedProductCubit()),
        ...
        BlocProvider<CityDeliverableCubit>(create: (_) => CityDeliverableCubit(AddressRepository())),
        BlocProvider<IsOrderDeliverableCubit>(create: (_) => IsOrderDeliverableCubit(AddressRepository())),
        ...
        BlocProvider<ReOrderCubit>(create: (_) => ReOrderCubit(OrderRepository())),
