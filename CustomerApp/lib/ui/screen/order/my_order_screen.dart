                                                                  ...
                                                                  if (mounted) {
                                                                    ...
                                                                    if (orderList[index].activeStatus == deliveredKey) {
                                                                      ...
                                                                      if (orderList[index].activeStatus == cancelledKey) {
                                                                        ...
                                                                        context.read<OrderDetailCubit>().clearOrderStatus();
                                              ...
                                              children: [
                                                Expanded(
                                                  ...
                                                  child: SmallButtonContainer(
                                                    ...
                                                    icon: Padding(
                                                      padding: EdgeInsetsDirectional.only(start: width! / 60.0),
                                                      child: Icon(Icons.refresh, color: Theme.of(context).colorScheme.onSurface, size: 15.0),
                                                    ),
                                                    onTap: () {
                                                ...
                                                Expanded(
                                                  child: orderList[index].activeStatus == deliveredKey
                                                      ? SmallButtonContainer(
                                                          ...
                                                          icon: Padding(
                                                            padding: EdgeInsetsDirectional.only(start: width!/60.0),
                                                            child: Icon(Icons.star_outline, color: Theme.of(context).colorScheme.onPrimary, size: 15.0),
                                                          ),
                                                          onTap: () {
                                                            if (mounted) {
