...
class SearchScreenState extends State<SearchScreen> {
  ...
  void startListening() {
    ...
    speech.listen(
        ...
        listenOptions: options, //cancelOnError: true,
    ...
    return List.generate(
      ...
      return GestureDetector(
        ...
        child: Container(padding: EdgeInsetsDirectional.only(start: 8.0, end: 8.0, top: 5.0, bottom: 5.0), margin: EdgeInsetsDirectional.only(end: width!/ 40.0, bottom: height!/ 80.0, start: index==0?width!/ 20.0:0.0), decoration: /* categoryId == t.id
                ...
                :  */DesignConfig.boxDecorationContainerBorder(textFieldBorder, Theme.of(context).colorScheme.onSurface, 100.0), child: Text(currentItem['keyWords'].toString(),style: TextStyle(color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.76), fontWeight: FontWeight.w500))),
      );
    });
  }
