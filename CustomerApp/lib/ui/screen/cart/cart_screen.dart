...
class CartScreenState extends State<CartScreen> {
  ...
  void initState() {
    ...
    if (context.read<AuthCubit>().state is AuthInitial || context.read<AuthCubit>().state is Unauthenticated) {
      ...
      context
          .read<GetCartCubit>()
          .getCartUser(/* userId: context.read<AuthCubit>().getId(),  */ branchId: context.read<SettingsCubit>().getSettings().branchId, from: "cart");
    }
        ...
        if (productVariantId!.isNotEmpty) {
          if (mounted) {
            await context
                ...
                .getOfflineCart(productVariantIds: productVariantId!.join(','), branchId: context.read<SettingsCubit>().getSettings().branchId);
          }
          cartEmpty = false;
        } else {
          cartEmpty = true;
  ...
  paymentScreenMove() {
    Navigator.of(context)
        .pushNamed(Routes.payment, arguments: {'cartModel': context.read<GetCartCubit>().getCartModel(), 'addNote': addNoteController.text});
  }
        ...
        child: IntlPhoneField(
          ...
          decoration: InputDecoration(
            ...
            labelStyle: TextStyle(
              color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.40),
              fontSize: 16.0,
  ...
  addToCartBottomModelSheet(
      List<ProductDetails> productList, int index, String variantId, int l, String? cartId, OfflineCartModel? offlineCartModel, String? cartQty) async {
    ...
    if (context.read<AuthCubit>().getId().isEmpty || context.read<AuthCubit>().getId() == "") {
      ...
      qty = int.parse(offlineCartModel!
          .qty!); //int.parse((await db.checkCartItemExists(productDetailsModel.id!, variantId, productAddOnIds.join(",").toString()))!);
      if (qty == 0) {
      ...
      if (productDetailsModel.variants![currentIndex].cartCount != "0") {
        qty = int.parse(cartQty! /* productDetailsModel.variants![currentIndex].cartCount! */);
      } else {
        qty = int.parse(productDetailsModel.minimumOrderQuantity!);
      }
      qtyData[productVariantId!] = qty;
                                                ...
                                                if (state is UpdateAddressSuccess) {
                                                  ...
                                                  if (addressId.isNotEmpty) {
                                                    context
                                                        ...
                                                        .fetchDeliveryCharge(/* context.read<AuthCubit>().getId(),  */ addressId);
                                                  }
                                              ...
                                              builder: (context, state) {
                                                return Container(
                                                  decoration: addressList[index].isDefault == "1"
                                                      ...
                                                      : DesignConfig.boxDecorationContainerBorder(
                                                          Theme.of(context).colorScheme.onPrimary, Theme.of(context).colorScheme.onSurface, 8,
                                                          status: true),
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        BlocConsumer<UpdateAddressCubit, UpdateAddressState>(
                                                          ...
                                                          builder: (context, state) {
                                                            return Theme(
                                                              data: Theme.of(context).copyWith(unselectedWidgetColor: greayLightColor),
                                                              child: Checkbox(
                                                                  ...
                                                                  fillColor: WidgetStatePropertyAll(addressList[index].isDefault == "1"
                                                                      ? Theme.of(context).colorScheme.secondary
                      ...
                      child: ButtonContainer(
                        ...
                        onPressed: () {
                          ...
                          Navigator.of(context).pushNamed(Routes.address,
                              arguments: {'from': 'cart', 'addressModel': AddressModel()}).then((value) => {refreshList()});
                        },
                      ),
                    ),
                  ],
    ...
    for (int i = 0; i < productDetails!.length; i++) {
      for (int j = 0; j < productDetails[i].variants!.length; j++) {
        if (productVariantId!.contains(productDetails[i].variants![j].id)) {
          ...
          String qty = (await db.checkCartItemExists(productDetails[i].id!, productDetails[i].variants![j].id!, addOnId.join(",").toString()))!;
                        ...
                        child: Column(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, i) {
                                int index = offlineCartList[i].variants!.indexWhere((product) => product.id == offlineCartDataList[i].vId);
                                List<ProductAddOnsModel> productAddonList = [];
                                VariantsModel variantData =
                                    offlineCartList.isNotEmpty ? offlineCartList[i].variants![index] : offlineCartList[i].variants![0];
                                ...
                                double off = 0;
                                if (offlineCartList[i].variants![index].specialPrice! != "0") {
                                ...
                                var sum = 0.0;
                                for (var h = 0; h < offlineCartList[i].productAddOns!.length; h++) {
                                  if (offlineCartDataList[i].addOnId!.contains(offlineCartList[i].productAddOns![h].id!)) {
                                    sum += double.parse(offlineCartList[i].productAddOns![h].price!) * int.parse(offlineCartDataList[i].qty!);
                                    productAddonList.add(offlineCartList[i].productAddOns![h]);
                                  }
                                }
                                double overAllTotal = ((price * int.parse(offlineCartDataList[i].qty!)) + sum);
                                                      ...
                                                      children: [
                                                        ...
                                                        Wrap(
                                                            children: List.generate(
                                                                /* offlineCartList[i].productAddOns!.length */ isExpanded[i]
                                                                    ? productAddonList.length
                                                                    : productAddonList.length > 6
                                                                        ? 6
                                                                        : productAddonList.length, (m) {
                                                          ProductAddOnsModel addOnData = productAddonList[m]; //offlineCartList[i].productAddOns![m];
                                                          return /* offlineCartDataList.isNotEmpty && offlineCartDataList[i].addOnId!.contains(addOnData.id!)
                                                            ?  */
                                                              Text(
                                                            "${addOnData.title!}, ",
                                                            textAlign: TextAlign.center,
                                                        ...
                                                        (/* offlineCartDataList[i].addOnId! */ productAddonList.isNotEmpty &&
                                                                productAddonList.length > 6)
                                                            ? InkWell(
                                                                onTap: () {
                                                                  setState(() {
                                                                ...
                                                                child: Text(
                                                                  isExpanded[i]
                                                                      ...
                                                                      : UiUtils.getTranslatedLabel(context, readMoreLabel),
                                                                  style: TextStyle(
                                                                    color: Theme.of(context).colorScheme.secondary,
                                                                    fontSize: 14,
                                                    ...
                                                    children: [
                                                      ...
                                                      InkWell(
                                                        onTap: () {
                                                          setState(() {
                                                            addToCartBottomModelSheet(
                                                                offlineCartList, i, variantData.id!, index, "", offlineCartDataList[i], "");
                                                          });
                                                        },
                                                        child: Container(
                                                          alignment: Alignment.center,
                                          ...
                                          Expanded(
                                              ...
                                              child: Column(mainAxisSize: MainAxisSize.min, children: [
                                                Container(
                                                  ...
                                                  height: 28.0,
                                                  width: width! / 4.8,
                                                  decoration: DesignConfig.boxDecorationContainerBorder(Theme.of(context).colorScheme.primary,
                                                      Theme.of(context).colorScheme.primary.withOpacity(0.12), 5.0),
                                                  child: Row(
                                                      mainAxisAlignment: MainAxisAlignment.center,
                                                      crossAxisAlignment: CrossAxisAlignment.center,
                                                      children: [
                                                        InkWell(
                                                          overlayColor:
                                                              WidgetStateProperty.all(Theme.of(context).colorScheme.onPrimary.withOpacity(0.10)),
                                                          onTap: () async {
                                                            productVariant = (await db.getCart());
                                                            productVariantData = (await db.getCartData());
                                                            ...
                                                            List<String> productAddons =
                                                                offlineCartDataList[i].addOnId!.split(',').map((str) => str.trim()).toList();

                                                            for (int qt = 0; qt < addOnsDataModel.length; qt++) {
                                                              if (productAddons.contains(addOnsDataModel[qt].id)) {
                                                                addOnIds.add(addOnsDataModel[qt].id.toString());
                                                                addOnQty.add((int.parse(offlineCartDataList[i].qty.toString()) - 1).toString());
                                                                totalSum += (double.parse(addOnsDataModel[qt].price!.toString()) *
                                                                    (int.parse(offlineCartDataList[i].qty.toString()) - 1));
                                                              }
                                                            }
                                                            double overAllTotalPrice =
                                                                (price * (int.parse(offlineCartDataList[i].qty.toString()) - 1) + totalSum);
                                                            print("productVariant${productVariant!["VID"].runtimeType}");

                                                            if (int.parse(offlineCartDataList[i].qty.toString()) == 1) {
                                                              db.removeCart(variantData.id!, offlineCartList[i].id!, context,
                                                                  int.parse(offlineCartDataList[i].id!));
                                                              ...
                                                              if (offlineCartDataList.isEmpty) {
                                                                db.clearCart();
                                                                offlineCartList.clear();
                                                                getOffLineCart();
                                                                clearOffLineCart(context);
                                                              ...
                                                              db
                                                                ...
                                                                context.read<OfflineCartCubit>().updateQuntity(
                                                                    ...
                                                                    ((int.parse(offlineCartDataList[i].qty.toString()) - 1)).toString(),
                                                                    variantData.id);
                                                                offlineCartDataList[i].qty = (int.parse(offlineCartDataList[i].qty!) - 1).toString();
                                                                setState(() {});
                                                              });
                                                            }
                                                            setState(() {});
                                                        ...
                                                        const Spacer(),
                                                        offlineCartDataList.isNotEmpty
                                                            ? Text(
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () {
                                                            ...
                                                            double overAllTotalPrice =
                                                                (price * (int.parse(offlineCartDataList[i].qty.toString()) + 1) + totalSum);
                                                            setState(() {
                                                              if (int.parse(offlineCartDataList[i].qty.toString()) <
                                                                  int.parse(offlineCartList[i].minimumOrderQuantity!)) {
                                                                UiUtils.setSnackBar(
                                                ...
                                                Text(
                                                  context.read<SystemConfigCubit>().getCurrency() + (overAllTotal).toStringAsFixed(2),
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(
                              ...
                              onTap: () {
                                Future.delayed(Duration.zero, () {
                                  if (widget.from == 'restaurantDetail') {
                                    ...
                                    // Navigator.of(context).pushReplacementNamed(Routes.home, arguments: {'id': 1});
                                    Navigator.of(context).pushNamedAndRemoveUntil(Routes.home, (Route<dynamic> route) => false, arguments: {'id': 1});
                                  }
                                });
                              },
                              child: Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 2.0),
                                  Text(
                                    UiUtils.getTranslatedLabel(context, addMoreFoodInCartLabel),
                                    ...
                                    return Padding(
                                      ...
                                      child: Row(children: [
                                        Text(UiUtils.getTranslatedLabel(context, totalPayLabel),
                                            textAlign: TextAlign.left,
                                            style:
                                                TextStyle(color: Theme.of(context).colorScheme.onPrimary, fontSize: 14, fontWeight: FontWeight.w700)),
                                        const Spacer(),
                        ...
                        child: Column(
                          ...
                          children: [
                                        ...
                                        child: Theme(
                                          ...
                                          child: Container(
                                            decoration: DesignConfig.boxDecorationContainerBorder(
                                                orderTypeIndex == 0 ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onPrimary,
                                                orderTypeIndex == 0
                            ...
                            orderTypeIndex == 1 || context.read<AddressCubit>().gerCurrentAddress().isDefault == ""
                                ...
                                : Container(
                                    padding: EdgeInsetsDirectional.only(
                                        start: width! / 20.0, top: height! / 80.0, end: width! / 20.0, bottom: height! / 99.0),
                                    width: width!,
                                    margin: EdgeInsetsDirectional.only(
                                      top: height! / 52.0,
                                    ),
                                        ...
                                        BlocConsumer<AddressCubit, AddressState>(
                                            ...
                                            builder: (context, state) {
                                              ...
                                              if (state is AddressSuccess) {
                                                ...
                                                return Row(children: [
                                                  SvgPicture.asset(
                                                    DesignConfig.setSvgPath("map_pin_line"),
                                                    height: 14,
                                                    width: 14,
                                                    fit: BoxFit.scaleDown,
                                                    colorFilter: ColorFilter.mode(Theme.of(context).colorScheme.onPrimary, BlendMode.srcIn),
                                                          ...
                                                          return ListView.builder(
                                                              ...
                                                              itemBuilder: (BuildContext context, i) {
                                                                ...
                                                                return state.addressList[i].isDefault == "0"
                                                                    ? Container()
                                                                    : Container(
                                                                        margin: EdgeInsetsDirectional.only(top: 5, start: width! / 20.0),
                                                                              ...
                                                                              children: [
                                                                                ClipOval(
                                                                                    child: DesignConfig.imageWidgets(
                                                                                        context.read<AuthCubit>().getProfile(), 20, 20, "1")),
                                                                                SizedBox(width: width! / 80.0),
                                              ...
                                              if (state is ClearCartSuccess) {
                                                if (context.read<AuthCubit>().state is AuthInitial ||
                                                  ...
                                                  context.read<GetCartCubit>().getCartUser(
                                                      /* userId: context.read<AuthCubit>().getId(), */ branchId:
                                                          context.read<SettingsCubit>().getSettings().branchId,
                                                      from: "cart");
                                                  setState(() {});
                                            ...
                                            builder: (context, state) {
                                              return InkWell(
                                                ...
                                                child: Text(
                                                  UiUtils.getTranslatedLabel(context, clearCartLabel),
                                                  style: TextStyle(
                                                      fontSize: 14, color: Theme.of(context).colorScheme.error, fontWeight: FontWeight.w500),
                                                ),
                                              );
                                            });
                                      }),
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  children: List.generate(cartList.data![i].productDetails!.length, (j) {
                                                    return Column(
                                                      children: List.generate(cartList.data![i].productDetails![j].variants!.length, (l) {
                                                        ...
                                                        if (cartList.data![i].productDetails![j].variants![l].addOnsData!.isNotEmpty) {
                                                          for (var k = 0;
                                                              k < cartList.data![i].productDetails![j].variants![l].addOnsData!.length;
                                                              k++) {
                                                            sum += double.parse(
                                                                cartList.data![i].productDetails![j].variants![l].addOnsData![k].price!.toString());
                                                          }
                                                        }
                                                                          ...
                                                                          child: Wrap(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              cartList.data![i].productDetails![j].variants![l].addOnsData!.isNotEmpty
                                                                                  ...
                                                                                  : SizedBox.shrink(),
                                                                              (cartList.data![i].productDetails![j].variants![l].addOnsData!
                                                                                          .isNotEmpty &&
                                                                                      cartList.data![i].productDetails![j].variants![l].addOnsData!
                                                                                              .length >
                                                                                          6)
                                                                              ...
                                                                              onTap: () {
                                                                                setState(() {
                                                                                  addToCartBottomModelSheet(
                                                                                      ...
                                                                                      variantData.id!,
                                                                                      l,
                                                                                      cartList.data![i].cartId,
                                                                                      OfflineCartModel(), cartList.data![i].qty);
                                                                                });
                                                                              },
                                                                              child: Container(
                                                                                padding: const EdgeInsets.all(2.0),
                                                                                ...
                                                                                child: Row(
                                                                                  children: [
                                                                                    ...
                                                                                    Icon(Icons.edit_outlined,
                                                                                        color: Theme.of(context).colorScheme.secondary, size: 12.0),
                                                                                  ],
                                                                                ),
                                                                              ),
                                                                            ),
                                                                      ...
                                                                      children: [
                                                                                ...
                                                                                if (context.read<AuthCubit>().state is AuthInitial ||
                                                                                  ...
                                                                                  context.read<GetCartCubit>().updateCartList(
                                                                                      currentCartModel.updateCart(
                                                                                          state.data,
                                                                                          (/* int.parse(currentCartModel.totalQuantity ??'0') + */
                                                                                  ...
                                                                                  if (promoCode != "") {
                                                                                    context.read<ValidatePromoCodeCubit>().getValidatePromoCode(
                                                                                        promoCode,
                                                                                        /* context.read<AuthCubit>().getId(), */ state.overallAmount!
                                                                                            .toStringAsFixed(2),
                                                                                        context.read<SettingsCubit>().getSettings().branchId);
                                                                                  }
                                                                                }
                                                                                    ...
                                                                                    children: [
                                                                                                ...
                                                                                                setState(() {
                                                                                                  if (int.parse(cartList.data![i].qty!) <=
                                                                                                    ...
                                                                                                    context.read<RemoveFromCartCubit>().removeFromCart(
                                                                                                        /* userId: context.read<AuthCubit>().getId(), */ /* productVariantId:cartList.data![i].productVariantId, */ cartId:
                                                                                                            cartList.data![i].cartId,
                                                                                                        branchId: context
                                                                                                            .read<SettingsCubit>()
                                                                                                            .getSettings()
                                                                                                    ...
                                                                                                    List<AddOnsDataModel> addOnsDataModel =
                                                                                                    ...
                                                                                                    context.read<ManageCartCubit>().manageCartUser(
                                                                                                        ...
                                                                                                        isSavedForLater: "0",
                                                                                                        qty: (int.parse(cartList.data![i].qty!) - 1)
                                                                                                            .toString(),
                                                                                                        addOnId: addOnIds.isNotEmpty
                                                                                                            ? addOnIds.join(",").toString()
                                                                                                            : "",
                                                                                                        addOnQty: addOnQty.isNotEmpty
                                                                                                  ...
                                                                                                  if (orderTypeIndex.toString() == "0") {
                                                                                                    finalTotal =
                                                                                                        cartList.overallAmount! + deliveryCharge;
                                                                                                  } else {
                                                                                                    finalTotal =
                                                                                                        cartList.overallAmount! - deliveryCharge;
                                                                                                  }
                                                                                                  if (promoCode != "") {
                                                                                                    context
                                                                                                        ...
                                                                                                        .getValidatePromoCode(
                                                                                                            promoCode,
                                                                                                            /* context.read<AuthCubit>().getId(), */ cartList
                                                                                                                .overallAmount!
                                                                                                                .toString(),
                                                                                                            context
                                                                                                                .read<SettingsCubit>()
                                                                                      ...
                                                                                      InkWell(
                                                                                        ...
                                                                                        onTap: () {
                                                                                          setState(() {
                                                                                            if (int.parse(cartList.data![i].qty!) <
                                                                                                int.parse(cartList.data![i].productDetails![j]
                                                                                                    .minimumOrderQuantity!)) {
                                                                                              // Navigator.pop(context);
                                                                                              UiUtils.setSnackBar(
                                                                                                  "${StringsRes.minimumQuantityAllowed} ${cartList.data![i].productDetails![j].minimumOrderQuantity!}",
                                                                                                  context,
                                                                                                  false,
                                                                                                  type: "2");
                                                                                            } else if (cartList.data![i].productDetails![j]
                                                                                                        .totalAllowedQuantity !=
                                                                                                    "" &&
                                                                                                int.parse(cartList.data![i].qty!) >=
                                                                                                    int.parse(cartList.data![i].productDetails![j]
                                                                                                        .totalAllowedQuantity!)) {
                                                                                              cartList.data![i].qty = cartList
                                                                                                  .data![i].productDetails![j].totalAllowedQuantity!;
                                                                                              UiUtils.setSnackBar(
                                                                                                  "${StringsRes.minimumQuantityAllowed} ${cartList.data![i].productDetails![j].totalAllowedQuantity!}",
                                                                                                  context,
                                                                                                  false,
                                                                                                  type: "2");
                                                                                            } else {
                                                                                              ...
                                                                                              for (int qt = 0; qt < addOnsDataModel.length; qt++) {
                                                                                                addOnIds.add(addOnsDataModel[qt].id.toString());
                                                                                                addOnQty.add(
                                                                                                    (int.parse(addOnsDataModel[qt].qty.toString()) +
                                                                                                            1)
                                                                                                        .toString());
                                                                                              }
                                                                                              context.read<ManageCartCubit>().manageCartUser(
                                                                        ...
                                                                        Text(
                                                                          context.read<SystemConfigCubit>().getCurrency() +
                                                                              (double.parse(price.toString()) * int.parse(cartList.data![i].qty!) +
                                                                                      (sum * int.parse(cartList.data![i].qty!)))
                                                                                  .toStringAsFixed(2),
                                                                          textAlign: TextAlign.center,
                                                                          style: TextStyle(
                                                                              color: Theme.of(context).colorScheme.secondary,
                                    ...
                                    onTap: () {
                                      Future.delayed(Duration.zero, () {
                                        if (widget.from == 'restaurantDetail') {
                                          ...
                                          //  Navigator.of(context).pushReplacementNamed(Routes.home, arguments: {'id': 1});
                                          Navigator.of(context)
                                              .pushNamedAndRemoveUntil(Routes.home, (Route<dynamic> route) => false, arguments: {'id': 1});
                                        }
                                      });
                                    },
                                    child: Row(
                            ...
                            InkWell(
                                  ...
                                  if (value != null) {
                                    setState(() {
                                      ...
                                      if (promoCode != "") {
                                        context.read<ValidatePromoCodeCubit>().getValidatePromoCode(
                                            promoCode,
                                            /* context.read<AuthCubit>().getId(), */ cartList.overallAmount!.toString(),
                                            context.read<SettingsCubit>().getSettings().branchId);
                                      }
                                      if (orderTypeIndex.toString() == "0") {
                              ...
                              child: Container(
                                ...
                                decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onSurface, 0.0),
                                padding:
                                    EdgeInsetsDirectional.only(top: height! / 40.0, bottom: height! / 40.0, start: width! / 20.0, end: width! / 20.0),
                                child: Column(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                                      ...
                                      SizedBox(width: width! / 80.0),
                                      Text(
                                        UiUtils.getTranslatedLabel(context, addCouponLabel),
                                        textAlign: TextAlign.center,
                                        style: TextStyle(color: Theme.of(context).colorScheme.onPrimary, fontSize: 14, fontWeight: FontWeight.w600),
                                      ),
                                      const Spacer(),
                                    ...
                                    promoCode != ""
                                        ? Padding(
                                            padding: EdgeInsetsDirectional.only(top: height! / 70.0, start: width! / 20.0, bottom: 5.0),
                                            child: Row(
                                              children: [
                                                  ...
                                                  if (state is ValidatePromoCodeFetchSuccess) {
                                                    return Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                          context.read<SystemConfigCubit>().getCurrency() +
                                                              double.parse(state.promoCodeValidateModel!.finalDiscount!).toStringAsFixed(2),
                                                          textAlign: TextAlign.start,
                                                          style: TextStyle(
                                                              color: Theme.of(context).colorScheme.secondary,
                                                              fontSize: 12,
                            ...
                            orderTypeIndex.toString() == "0"
                                ? Container(
                                    width: width!,
                                    padding: EdgeInsetsDirectional.only(
                                        start: width! / 20.0, top: height! / 40.0, end: width! / 20.0, bottom: height! / 40.0),
                                    margin: EdgeInsetsDirectional.only(
                                      top: height! / 52.0,
                                    ),
                                    decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onSurface, 0.0),
                                    child: Column(children: [
                                          ...
                                          Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    SvgPicture.asset(DesignConfig.setSvgPath("hand_coin_line"),
                                                        height: 14,
                                                        width: 14,
                                                        fit: BoxFit.scaleDown,
                                                        colorFilter: ColorFilter.mode(Theme.of(context).colorScheme.onPrimary, BlendMode.srcIn)),
                                                    SizedBox(width: width! / 80.0),
                                                    Text(
                                                      UiUtils.getTranslatedLabel(context, tipDeliveryPartnerLabel),
                                                      textAlign: TextAlign.start,
                                                      style: TextStyle(
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(UiUtils.getTranslatedLabel(context, tipDeliveryPartnerSubTitleLabel),
                                                      textAlign: TextAlign.start,
                                                      style:
                                                          TextStyle(color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.76), fontSize: 11),
                                                      maxLines: 2),
                                                ),
                                              ],
                                            ),
                                          ...
                                          deliveryTip == 0
                                              ...
                                              : Column(
                                                  children: [
                                                    ...
                                                    const SizedBox(height: 5.0),
                                                    Text(
                                                      context.read<SystemConfigCubit>().getCurrency() + deliveryTip.toStringAsFixed(2),
                                                      textAlign: TextAlign.start,
                                                      style: TextStyle(
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.only(top: height! / 70.0, bottom: height! / 70.0, start: width! / 20.0),
                                        child: DesignConfig.divider(),
                                      ),
                                      deliveryTips(),
                                    ]),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      SvgPicture.asset(DesignConfig.setSvgPath("add_note_line"),
                                          height: 14,
                                          width: 14,
                                          fit: BoxFit.scaleDown,
                                          colorFilter: ColorFilter.mode(Theme.of(context).colorScheme.onPrimary, BlendMode.srcIn)),
                                      ...
                                      Text(UiUtils.getTranslatedLabel(context, addNotesForFoodPartnerLabel),
                                          textAlign: TextAlign.start,
                                          style:
                                              TextStyle(color: Theme.of(context).colorScheme.onPrimary, fontSize: 14, fontWeight: FontWeight.w600)),
                                    ],
                                  ),
                                  Padding(
                                    padding: EdgeInsetsDirectional.only(top: height! / 70.0, bottom: height! / 70.0, start: width! / 20.0),
                            ...
                            Container(
                              padding:
                                  EdgeInsetsDirectional.only(start: width! / 20.0, top: height! / 40.0, end: width! / 20.0, bottom: height! / 80.0),
                              width: width!,
                              margin: EdgeInsetsDirectional.only(
                                top: height! / 52.0,
                              ),
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(children: [
                                    ...
                                    const Spacer(),
                                    Text(
                                      context.read<SystemConfigCubit>().getCurrency() + (subTotal).toStringAsFixed(2),
                                      textAlign: TextAlign.end,
                                      style: TextStyle(
                                          color: Theme.of(context).colorScheme.secondary,
                                          fontSize: 14,
                                ...
                                Padding(
                                  ...
                                  child: Row(children: [
                                    ...
                                    const Spacer(),
                                    Text(
                                      context.read<SystemConfigCubit>().getCurrency() + cartList.taxAmount!,
                                      textAlign: TextAlign.end,
                                      style: TextStyle(
                                          color: Theme.of(context).colorScheme.secondary,
                                          fontSize: 14,
                                ...
                                Padding(
                                  ...
                                  child: Row(children: [
                                    ...
                                    const Spacer(),
                                    Text(
                                      context.read<SystemConfigCubit>().getCurrency() + (subTotal + taxAmount).toStringAsFixed(2),
                                      textAlign: TextAlign.end,
                                      style: TextStyle(
                                          color: Theme.of(context).colorScheme.secondary,
                                          fontSize: 14,
                                ...
                                orderTypeIndex.toString() == "0"
                                    ? Padding(
                                        ...
                                        child: Row(children: [
                                          Text(
                                            UiUtils.getTranslatedLabel(context, deliveryTipLabel),
                                            textAlign: TextAlign.left,
                                            style:
                                          ...
                                          const Spacer(),
                                          Text(
                                            context.read<SystemConfigCubit>().getCurrency() + deliveryTip.toString(),
                                            textAlign: TextAlign.end,
                                            style: TextStyle(
                                                color: Theme.of(context).colorScheme.secondary,
                                                fontSize: 14,
                                    ...
                                    ? BlocConsumer<DeliveryChargeCubit, DeliveryChargeState>(
                                        ...
                                        builder: (context, state) {
                                          if (state is DeliveryChargeSuccess) {
                                            ...
                                            return Padding(
                                              padding: EdgeInsetsDirectional.only(top: 4.5, bottom: height! / 99.0, start: width! / 20.0),
                                              child: Column(children: [
                                                Row(
                                                  children: [
                                                    Text(
                                                      UiUtils.getTranslatedLabel(context, deliveryChargesLabel),
                                                      textAlign: TextAlign.left,
                                                      style: TextStyle(
                                                          color: Theme.of(context).colorScheme.onPrimary, fontSize: 14, fontWeight: FontWeight.w500),
                                                    ),
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(children: [
                                                    Text(
                                                      UiUtils.getTranslatedLabel(context, totalPayLabel),
                                                      textAlign: TextAlign.left,
                                                      style: TextStyle(
                                                    ...
                                                    const Spacer(),
                                                    Text(
                                                      context.read<SystemConfigCubit>().getCurrency() + /* (finalTotal + deliveryTip) */
                          ...
                          builder: (context, state) {
                            ...
                            return ButtonContainer(
                              ...
                              text: (state is OfflineCartSuccess)
                                  ? UiUtils.getTranslatedLabel(context, confirmOrderLabel)
                                  : UiUtils.getTranslatedLabel(context, browseMenuLabel),
                              start: width! / 40.0,
                              end: width! / 40.0,
                              bottom: height! / 55.0,
                              top: 0,
                                          ...
                                          return BlocConsumer<GetCartCubit, GetCartState>(
                                              ...
                                              listener: (context, getCartstate) {
                                                if (getCartstate is GetCartSuccess) {
                                                  print("from:${getCartstate.from}");
                                                  for (int i = 0; i < addressList.length; i++) {
                                                    if (addressList[i].isDefault == "1") {
                                                      if(getCartstate.from=="cart"){
                                                      context
                                                          .read<DeliveryChargeCubit>()
                                                          .fetchDeliveryCharge(/* context.read<AuthCubit>().getId(),  */ addressList[i].id!);
                                                      }
                                                  ...
                                                  child: BlocBuilder<DeliveryChargeCubit, DeliveryChargeState>(
                                                      ...
                                                      builder: (context, state) {
                                                        ...
                                                        return ButtonContainer(
                                                          ...
                                                          height: height,
                                                          width: width,
                                                          text: (getCartstate is GetCartSuccess)
                                                              ? UiUtils.getTranslatedLabel(context, confirmOrderLabel)
                                                              : UiUtils.getTranslatedLabel(context, browseMenuLabel),
                                                          start: width! / 40.0,
                                                          end: width! / 40.0,
