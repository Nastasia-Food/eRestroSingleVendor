              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Container(
                      decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onSurface, 8.0),
                      padding: const EdgeInsetsDirectional.all(10.0),
                      margin: EdgeInsetsDirectional.only(bottom: height! / 80.0, start: width! / 20.0/* 99.0 */, end: width! / 70.0),
                      child: Column(children: [
                        CircleAvatar(
                            radius: 18.0,
                            backgroundColor: Theme.of(context).colorScheme.primary,
              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Container(
                      decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onSurface, 8.0),
                      padding: const EdgeInsetsDirectional.all(10.0),
                      margin: EdgeInsetsDirectional.only(bottom: height! / 80.0, start: width! / 70.0, end: width! / 20.0),
                      child: Column(children: [
                        CircleAvatar(
                            radius: 18.0,
                            backgroundColor: Theme.of(context).colorScheme.primary,
  ...
  Widget logInAndLogoutButton() {
    return GestureDetector(
      ...
      child: Container(
        ...
        ], borderRadius: BorderRadius.circular(8), color: Theme.of(context).colorScheme.onSurface),
        width: width! / 3.0,
        height: height! / 22,
