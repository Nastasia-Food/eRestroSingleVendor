...
class LoginScreenState extends State<LoginScreen> {
  ...
  TextEditingController phoneNumberController = TextEditingController(text: "9876543212");
  TextEditingController passwordController = TextEditingController(text: "");
  String? countryCode = defaulCountryCode;
  FocusNode numberFocusNode = FocusNode();
  FocusNode numberFocusNodeAndroid = FocusNode();
  bool obscure = true, status = false, iAccept = false, skipStatus = false, loginStatus = false;
      ...
      try {
        if (context.read<SystemConfigCubit>().getDemoMode() == "0") {
          ...
          await Future.delayed(
              Duration.zero, () => Navigator.of(context).pushNamedAndRemoveUntil(Routes.home, (Route<dynamic> route) => false, arguments: {'id': 0}));
        } else {
                    ...
                    ? ButtonImageContainer(
                        ...
                        onPressed: () {
                          if (iAccept == true) {
                            ...
                            UiUtils.setSnackBar(StringsRes.pleaseAcceptTermCondition, context, false, type: "2");
                          }
                        },
                        widget: SvgPicture.asset(DesignConfig.setSvgPath("google")))
                    : const SizedBox.shrink(),
                Platform.isIOS && context.read<SystemConfigCubit>().isAppleLoginEnable() == "1"
                    ? ButtonImageContainer(
                        color: textFieldBackground,
                        height: height,
                        width: width,
                ...
                child: Row(
                  ...
                  children: [
                    Theme(
                      ...
                      child: Checkbox(
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4), side: BorderSide(color: textFieldBackground)),
                          value: iAccept,
                          ...
                          fillColor: WidgetStatePropertyAll(iAccept == true ? Theme.of(context).colorScheme.secondary : textFieldBackground),
                    ...
                    Expanded(
                      child: RichText(
                        text: TextSpan(
                          text: UiUtils.getTranslatedLabel(context, byClickingYouAgreeToOurLabel),
                          style: TextStyle(color: Theme.of(context).colorScheme.onPrimary, fontSize: 14.0, fontFamily: 'Quicksand'),
                          children: [
                            TextSpan(
                                text: "  ${UiUtils.getTranslatedLabel(context, termsOfServiceLabel)}",
                                style: TextStyle(
                            ...
                            TextSpan(
                                text: " ${UiUtils.getTranslatedLabel(context, andTheLabel)} ",
                                style: TextStyle(
                                    ...
                                    fontFamily: 'Quicksand')),
                            TextSpan(
                                text: UiUtils.getTranslatedLabel(context, privacyPolicyLbLabel),
                                style: TextStyle(
                                    decoration: TextDecoration.none,
                                    color: Theme.of(context).colorScheme.secondary,
                                    fontSize: 14.0,
              ...
              body: BlocBuilder<SystemConfigCubit, SystemConfigState>(
                builder: (context, state) {
                  return CustomScrollView(
                    ...
                    slivers: [
                      SliverAppBar(
                        shadowColor: Theme.of(context).colorScheme.onPrimary.withOpacity(0.1),
                        ...
                        centerTitle: false,
                        flexibleSpace:
                            DesignConfig.appBarWihoutBackbutton(context, width, "", const PreferredSize(preferredSize: Size.zero, child: SizedBox())),
                        floating: false,
                        pinned: true,
                        title: Text(UiUtils.getTranslatedLabel(context, loginLabel),
                            style: TextStyle(fontSize: 18.0, color: Theme.of(context).colorScheme.onPrimary, fontWeight: FontWeight.w700)),
                        actions: [
                          skipStatus == true
                              ? Lottie.asset(DesignConfig.setLottiePath("addressProgress"))
                              : SizedBox(
                                  width: width / 5.0,
                      ...
                      SliverFillRemaining(
                        hasScrollBody: false,
                        child: Padding(
                          padding: EdgeInsetsDirectional.only(top: height / 20.0, start: width / 20.0, end: height / 40.0),
                          child: Form(
                            key: _formKey,
                            child: Column(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              Align(
                                ...
                                child: Text(
                                  UiUtils.getTranslatedLabel(context, loginTitleLabel),
                                  style: TextStyle(
                                      decoration: TextDecoration.none,
                                      color: Theme.of(context).colorScheme.onPrimary,
                                      fontSize: 32.0,
                              ...
                              Align(
                                alignment: Alignment.topLeft,
                                child: Text(
                                  UiUtils.getTranslatedLabel(context, loginSubTitleLabel),
                                  style: TextStyle(
                                      decoration: TextDecoration.none,
                                      color: Theme.of(context).colorScheme.onPrimary,
                                      fontSize: 18.0,
                              ...
                              context.read<SystemConfigCubit>().isOtpLoginEnable() == "1"
                                  ? IntlPhoneField(
                                      ...
                                      dropdownTextStyle:
                                          TextStyle(color: Theme.of(context).colorScheme.onPrimary, fontSize: 16.0, fontWeight: FontWeight.w500),
                                          ...
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (BuildContext context) => OtpVerifyScreen(
                                                  mobileNumber: phoneNumberController.text, countryCode: countryCode, from: widget.from, type: "sms"),
                                            ),
                                          ).then((value) {
                                            setState(() {
                                              loginStatus = false;
                              ...
                              context.read<SystemConfigCubit>().isOtpLoginEnable() == "1"
                                  ? Row(children: [
                                      ...
                                      Text(
                                        UiUtils.getTranslatedLabel(context, orSignInWithLabel),
                                        style: TextStyle(
                                          color: Theme.of(context).colorScheme.onPrimary,
                                          fontSize: 14.0,
                                          fontWeight: FontWeight.w500,
