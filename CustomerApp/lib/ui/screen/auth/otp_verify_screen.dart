...
import 'package:erestroSingleVender/ui/screen/auth/resendOtpTimerContainer.dart';
...
class _OtpVerifyScreenState extends State<OtpVerifyScreen> with SingleTickerProviderStateMixin {
  ...
  login() async {
    await Future.delayed(Duration.zero, () => context.read<SignInCubit>().signInUser(mobile: widget.mobileNumber));
  }
                                      ...
                                      builder: (context, state) {
                                        return SizedBox(
                                          ...
                                          child: ButtonContainer(
                                            color: (codeSent||(controller.text.length == 6)) ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.surface,
                                            height: height,
                                            width: width,
