  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: _item.isSelected!
          ...
          : DesignConfig.boxDecorationContainerBorder(Theme.of(context).colorScheme.onPrimary, Theme.of(context).colorScheme.onSurface, 8,
              status: true),
            ...
            _item.img != ""
                ? Container(
                    ...
                    decoration: DesignConfig.boxDecorationContainerBorderCustom(
                        Theme.of(context).colorScheme.onPrimary.withOpacity(0.50), Theme.of(context).colorScheme.onSurface, 5.0),
