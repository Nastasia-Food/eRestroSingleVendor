      ...
      itemBuilder: (BuildContext context, int index) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.only(start: width! / 20.0, bottom: height! / 12.0),
                child: Text(
                  introductionSliderList[currentIndex].title!,
                  style: TextStyle(fontSize: 32, color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.bold),
                  textAlign: TextAlign.start,
                ),
              ),
              Padding(
                padding: EdgeInsetsDirectional.only(top: height! / 28.0),
                child: SvgPicture.asset(DesignConfig.setSvgPath(introductionSliderList[index].image!)),
              ),
              Padding(
                padding: EdgeInsetsDirectional.only(top: height! / 20.0, bottom: height! / 40.0, start: width! / 20.0, end: width! / 20.0),
                child: Text(
