...
import 'package:erestroSingleVender/data/model/chatModel.dart';
            ...
            ? Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: message.userId == context.read<AuthCubit>().getId() ? CrossAxisAlignment.end : CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("${message.message}", style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 12)),
                      Padding(
                        padding: const EdgeInsetsDirectional.only(top: 5),
                        child: Text(message.dateCreated!, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 9)),
                      ),
                    ],
                  ),
                ),
            ...
            child: Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Expanded(
                    child: Container(
                      decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.surface, 0),
                      child: Row(
                        children: [
                          Expanded(
                            child: TextField(
