            ...
            return InkWell(
              ...
              child: Container(
                  ...
                  decoration: DesignConfig.boxDecorationContainerCardShadow(
                      Theme.of(context).colorScheme.onSurface, Theme.of(context).colorScheme.onPrimary.withOpacity(0.1), 8.0, 0, 0, 8, 0),
                  child: Row(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Row(
                              children: [
                                ...
                                const Spacer(),
                                FavoriteContainer(from: "product", productDetails: widget.productDetails),
                              ],
                            ),
                                                          ...
                                                          if (state is ManageCartSuccess) {
                                                            if (context.read<AuthCubit>().state is AuthInitial ||
                                                              ...
                                                              context.read<GetCartCubit>().updateCartList(currentCartModel.updateCart(
                                                                  state.data,
                                                                  (/* int.parse(currentCartModel.totalQuantity ?? '0') +  */ int.parse(
                                                                          state.totalQuantity!))
                                                                      .toString(),
                                                                  state.subTotal,
                                                                  state.taxPercentage,
                                                            ...
                                                            child: Row(
                                                                ...
                                                                children: [
                                                                          ...
                                                                          onTap: () async {
                                                                            if (context.read<SettingsCubit>().getSettings().isBranchOpen == "1") {
                                                                              bool check = getStoreOpenStatus(
                                                                                  widget.productDetails.startTime!, widget.productDetails.endTime!);
                                                                              if ((widget.productDetails.availableTime == "1" && check == true) ||
                                                                                  (widget.productDetails.availableTime == "0")) {
                                                                                if (widget.productDetails.variants!.length >= 1 &&
                                                                                    widget.productDetails.productAddOns!.isNotEmpty) {
                                                                                  ...
                                                                                  if (priceCurrent == 0) {
                                                                                    priceCurrent =
                                                                                        double.parse(widget.productDetails.variants![0].price!);
                                                                                  }
                                                                                  ...
                                                                                  if (int.parse(context.read<GetQuantityCubit>().fetchQty()) == 1) {
                                                                                    if (context.read<AuthCubit>().getId().isEmpty ||
                                                                                        context.read<AuthCubit>().getId() == "") {
                                                                                      db.removeCart(widget.productDetails.variants![0].id!,
                                                                                          widget.productDetails.id!, context, offlineCartItemId);
                                                                                    } else {
                                                                                      context.read<RemoveFromCartCubit>().removeFromCart(
                                                                                          /* userId: context.read<AuthCubit>().getId(), */
                                                                                          /* productVariantId */ cartId: widget.productDetails.cartId,
                                                                                          branchId:
                                                                                              context.read<SettingsCubit>().getSettings().branchId);
                                                                                    }
                                                                                  } else {
                                                                                    if (context.read<AuthCubit>().getId().isEmpty ||
                                                                                      ...
                                                                                      context.read<ManageCartCubit>().manageCartUser(
                                                                                          ...
                                                                                          branchId:
                                                                                              context.read<SettingsCubit>().getSettings().branchId,
                                                                                          cartId: widget.productDetails.cartId);
                                                                                    }
                                                                                  }
                                                                                  Future.delayed(const Duration(seconds: 1), () {
                                                                                    if (mounted) {
                                                                  ...
                                                                  Text(context.read<GetQuantityCubit>().fetchQty(),
                                                                      /* context.read<GetCartCubit>().AllVarianntQty(widget.dataItem.id!, widget.dataItem) */
                                                                      textAlign: TextAlign.center,
                                                                      style: TextStyle(
                                                                          color: Theme.of(context).colorScheme.onPrimary,
                                                                          fontWeight: FontWeight.w700,
