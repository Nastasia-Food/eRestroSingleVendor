    ...
    return Builder(builder: (context) {
      return Container(
        ...
        child: Stack(
          ...
          children: [
            Container(decoration: DesignConfig.boxDecorationBorder(Theme.of(context).colorScheme.onPrimary.withOpacity(0.20), 10, status: true),
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            SizedBox(width: axis == "horizontal" ? width!/2.3: width!/ 1.5,
                              child: Text(
                                productDetails.name!,
