  ...
  addToCartBottomModelSheet(ProductDetails productList) async {
    ...
    showModalBottomSheet(
      ...
      Future.delayed(const Duration(seconds: 1), () {
        if(mounted){
          context.read<GetQuantityCubit>().getQuantity(productList.id!, productList, navigatorKey.currentContext!);
        }
      });
    });
  }
                ...
                onTap: () {
                  if (context.read<SettingsCubit>().getSettings().isBranchOpen == "1") {
                    ...
                    if (widget.dataItem.availableTime == "1") {
                      if (check == true) {
                        addToCartBottomModelSheet(context.read<GetCartCubit>().getProductDetailsData(widget.dataItem.id!, widget.dataItem)[0]);
                      } else {
                        showDialog(
                            context: context,
                            builder: (_) => ProductUnavailableDialog(
                                startTime: widget.dataItem.startTime, endTime: widget.dataItem.endTime, width: widget.width, height: widget.height));
                      }
                    } else {
                      addToCartBottomModelSheet(context.read<GetCartCubit>().getProductDetailsData(widget.dataItem.id!, widget.dataItem)[0]);
                    }
                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                    ...
                                    ClipRRect(
                                        ...
                                        child: ColorFiltered(
                                          ...
                                          child: ShaderMask(
                                              ...
                                              child: DesignConfig.imageWidgets(widget.dataItem.image!, widget.height! / 6.5, widget.width!, "2")),
                                        )),
                            ...
                            Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.only(
                                    start: widget.width! / 50.0, /* top: widget.height! / 99.0,  */ bottom: widget.height! / 99.0),
                                    ...
                                    children: [
                                      widget.dataItem.indicator == "1"
                                          ...
                                          : widget.dataItem.indicator == "2"
                                              ...
                                              : const SizedBox(),
                                      (widget.dataItem.rating == "0" || widget.dataItem.rating == "0.0" || widget.dataItem.rating == "0.00")
                                          ? const SizedBox()
                                          : Padding(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  Navigator.of(context)
                                                      .pushNamed(Routes.productRatingDetail, arguments: {'productId': widget.dataItem.id!});
                                                },
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                      double.parse(widget.dataItem.rating!).toStringAsFixed(1),
                                                      textAlign: TextAlign.center,
                                                      style: TextStyle(
                                      ...
                                      const Spacer(),
                                      FavoriteContainer(from: "product", productDetails: widget.dataItem),
                                    ],
                                  ),
                                  Row(
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(context.read<SystemConfigCubit>().getCurrency() + widget.price.toString(),
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                  color: Theme.of(context).colorScheme.secondary, fontSize: 16, fontWeight: FontWeight.w700)),
                                                      ...
                                                      if (widget.dataItem.availableTime == "1") {
                                                        if (check == true) {
                                                          addToCartBottomModelSheet(context
                                                              .read<GetCartCubit>()
                                                              .getProductDetailsData(widget.dataItem.id!, widget.dataItem)[0]);
                                                        } else {
                                                          showDialog(
                                                              context: context,
                                                              builder: (_) => ProductUnavailableDialog(
                                                                        ...
                                                                        builder: (context, state) {
                                                                          return InkWell(
                                                                            ...
                                                                            if ((widget.dataItem.availableTime == "1" && check==true) || (widget.dataItem.availableTime == "0")) {
                                                                              if (widget.dataItem.variants!.length >= 1 &&
                                                                                  widget.dataItem.productAddOns!.isNotEmpty) {
                                                                                editToCartBottomModelSheet(widget.dataItem);
                                                                              } else {
                                                                                int offlineCartItemId = int.parse((await db.checkItemExists(
                                                                                    widget.dataItem.id!, widget.dataItem.variants![0].id!))!);
                                                                                double priceCurrent =
                                                                                    double.parse(widget.dataItem.variants![0].specialPrice!);
                                                                                if (priceCurrent == 0) {
                                                                                ...
                                                                                if (int.parse(context.read<GetQuantityCubit>().fetchQty()) == 1) {
                                                                                  if (context.read<AuthCubit>().getId().isEmpty ||
                                                                                      context.read<AuthCubit>().getId() == "") {
                                                                                    db.removeCart(widget.dataItem.variants![0].id!,
                                                                                        widget.dataItem.id!, context, offlineCartItemId);
                                                                                  } else {
                                                                                    context.read<RemoveFromCartCubit>().removeFromCart(
                                                                                        /* userId: context.read<AuthCubit>().getId(), */
                                                                                        /* productVariantId */ cartId:
                                                                                            widget.dataItem.cartId,
                                                                                        branchId:
                                                                                            context.read<SettingsCubit>().getSettings().branchId);
                                                                                  }
                                                                                } else {
                                                                                  if (context.read<AuthCubit>().getId().isEmpty ||
                                                                                    ...
                                                                                    db
                                                                                        .insertCart(
                                                                                            ...
                                                                                            context.read<SettingsCubit>().getSettings().branchId,
                                                                                            context,
                                                                                            id: offlineCartItemId)
                                                                                        .then((value) {
                                                                                      Future.delayed(const Duration(seconds: 1), () {
                                                                                        if(mounted){
                                                                                        context.read<GetQuantityCubit>().getQuantity(
                                                                                            widget.dataItem.id!, widget.dataItem, context);
                                                                                        }
                                                                                      });
                                                                                    });
                                                                                  } else {
                                                                                    context.read<ManageCartCubit>().manageCartUser(
                                                                                        ...
                                                                                        isSavedForLater: "0",
                                                                                        qty: (int.parse(context.read<GetQuantityCubit>().fetchQty()) -
                                                                                                1)
                                                                                            .toString(),
                                                                                        addOnId: "",
                                                                                        addOnQty: "",
                                                                                        branchId: context.read<SettingsCubit>().getSettings().branchId,
                                                                                        cartId: widget.dataItem.cartId);
                                                                                  }
                                                                                }
                                                                                Future.delayed(const Duration(seconds: 1), () {
                                                                                  context
                                                                            ...
                                                                            child: Container(
                                                                                decoration: DesignConfig.boxDecorationContainer(
                                                                                    Theme.of(context).colorScheme.onSurface, 2.0),
                                                                            ...
                                                                            setState(() {
                                                                              if (int.parse(context.read<GetQuantityCubit>().fetchQty()) <
                                                                                ...
                                                                                UiUtils.setSnackBar(
                                                                                    ...
                                                                                    false,
                                                                                    type: "2");
                                                                              } else if (widget.dataItem.totalAllowedQuantity != "" &&
                                                                                  int.parse(context.read<GetQuantityCubit>().fetchQty()) >=
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.only(top: widget.height! / 50.0, bottom: widget.height! / 50.0),
