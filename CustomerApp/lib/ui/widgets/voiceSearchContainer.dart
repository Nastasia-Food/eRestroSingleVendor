...
class VoiceSearchContainer extends StatelessWidget {
  ...
  final String? from;
  const VoiceSearchContainer({Key? key, this.width, this.height, this.from}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Container(
        padding: const EdgeInsets.all(8.0),
        margin: EdgeInsetsDirectional.only(start: width! / 50.0, top: height! / 99.0, bottom: height! / 99.0),
