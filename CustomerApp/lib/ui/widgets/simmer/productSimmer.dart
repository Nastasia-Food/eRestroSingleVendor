...
class ProductSimmer extends StatelessWidget {
  ...
  const ProductSimmer({Key? key, this.length, this.width, this.height}) : super(key: key);
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Expanded(
                      ...
                      child: ClipRRect(
                          ...
                          child: Container(color: shimmerContentColor, width: width! / 5.0, height: height! / 6.5))),
                  Expanded(
                      flex: 5,
                      child: Padding(
