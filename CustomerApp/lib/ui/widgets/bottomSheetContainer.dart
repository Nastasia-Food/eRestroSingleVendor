                                  ...
                                  children: [
                                    Row(
                                      children: [
                                            ...
                                            : Padding(
                                                ...
                                                child: GestureDetector(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    decoration: DesignConfig.boxDecorationContainer(Theme.of(context).colorScheme.onSurface, 2),
                                                    child: Row(
                                                      children: [
                                        ...
                                        const Spacer(),
                                        FavoriteContainer(from: "product", productDetails: widget.productDetailsModel),
                                      ],
                                    ),
                                ...
                                ? BlocBuilder<AuthCubit, AuthState>(builder: (context, state) {
                                    return BlocConsumer<ManageCartCubit, ManageCartState>(
                                        ...
                                        listener: (context, state) {
                                          print("bottomSheetManageCartState:${state.toString()}");
                                                      ...
                                                      if (context.read<AuthCubit>().state is AuthInitial ||
                                                        ...
                                                        if (context.read<SettingsCubit>().state.settingsModel!.branchId.toString() ==
                                                          ...
                                                          db
                                                              .insertCart(
                                                                  ...
                                                                  context,
                                                                  edit: widget.from == "cart"?true:false,
                                                                  id: widget.from == "cart"?int.parse(widget.id!):1)
                                                              .whenComplete(() async {
                                                        ...
                                                        if (qty < int.parse(widget.productDetailsModel.minimumOrderQuantity!)) {
                                                          ...
                                                          context.read<ManageCartCubit>().manageCartUser(
                                                              ...
                                                              cartId: widget.from == "cart" ? widget.cartId : "",
                                                              from: "bottom");
                                                        }
                                                      }
                                                      db.getCart();
