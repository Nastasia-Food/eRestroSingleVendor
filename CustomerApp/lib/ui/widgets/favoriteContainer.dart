                      ...
                      child: isProductFavorite
                          ? Container(
                              ...
                              child: SvgPicture.asset(DesignConfig.setSvgPath("wishlist-filled"),
                                  colorFilter: ColorFilter.mode(Theme.of(context).colorScheme.error, BlendMode.srcIn), width: 20.0, height: 20))
                          : Container(
                              alignment: Alignment.center,
                              child: SvgPicture.asset(DesignConfig.setSvgPath("wishlist1"),
                                  colorFilter: ColorFilter.mode(Theme.of(context).colorScheme.onPrimary, BlendMode.srcIn), width: 20.0, height: 20)));
                },
              );
            }
