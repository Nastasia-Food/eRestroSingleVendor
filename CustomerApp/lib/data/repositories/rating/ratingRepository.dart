...
class RatingRepository {
  ...
  Future setProductRating(String? userId, List? productRatingDataString) async {
    try {
      final result = await _ratingRemoteDataSource.setProductRating(userId, productRatingDataString);
      return result;
