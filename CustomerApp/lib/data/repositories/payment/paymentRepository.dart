import 'package:erestroSingleVender/data/repositories/payment/paymentRemoteDataSource.dart';
...
class PaymentRepository {
  ...
  Future<Map<String, dynamic>> sendWalletRequest(/* String? userId,  */String? amount, String? paymentAddress) async {
    try {
