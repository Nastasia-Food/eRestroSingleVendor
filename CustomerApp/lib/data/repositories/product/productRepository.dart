...
class ProductRepository {
  ...
  Future<List<OfflineCartModel>> getOfflineCart(ProductDetails productDetails, BuildContext context) async {
    if (context.read<AuthCubit>().state is AuthInitial || context.read<AuthCubit>().state is Unauthenticated) {
      ...
      offlineCartList = (data as List).map((e) => OfflineCartModel.fromJson(e)).toList();
