...
//to manageCart
  ...
  //to removeCart
  Future<dynamic> removeCart({/* String? userId,  *//* String? productVariantId, */ String? cartId, String? branchId}) async {
    try {
      //body of post request
      final body = {/* userIdKey: userId,  *//* productVariantIdKey: productVariantId, */ cartIdKey: cartId, branchIdKey: branchId};
  ...
  //to getUserCart
  Future<CartModel> getCart({/* String? userId,  */String? branchId, String? from}) async {
    try {
      //body of post request
      final body = {/* userIdKey: userId,  */branchIdKey: branchId};
