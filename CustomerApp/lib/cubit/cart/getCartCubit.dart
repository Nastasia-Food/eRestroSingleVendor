...
class GetCartCubit extends Cubit<GetCartState> {
  ...
  //to getCart user
  getCartUser({/* String? userId,  */String? branchId, String? from=""}) {
    //emitting GetCartProgress state
    emit(GetCartProgress());
    //GetCart user with given user id details in api
    _cartRepository.getCartData(/* userId,  */branchId, from).then((value) => emit(GetCartSuccess(value, from!))).catchError((e) {
