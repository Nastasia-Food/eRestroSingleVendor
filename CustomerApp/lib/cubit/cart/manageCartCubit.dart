...
class ManageCartSuccess extends ManageCartState {
  ...
  final String? from;
  ManageCartSuccess(this.data, this.totalQuantity, this.subTotal, this.taxPercentage, this.taxAmount, this.overallAmount, this.variantId, this.from);
}
...
class ManageCartCubit extends Cubit<ManageCartState> {
  ...
  //to manageCart user
  void manageCartUser(
      {/* String? userId,  */String? productVariantId, String? isSavedForLater, String? qty, String? addOnId, String? addOnQty, String? branchId, String? cartId, String? from=""}) {
