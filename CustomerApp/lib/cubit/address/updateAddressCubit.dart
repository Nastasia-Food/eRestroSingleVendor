...
class UpdateAddressCubit extends Cubit<UpdateAddressState> {
  ...
  void fetchUpdateAddress(
    ...
    _addressRepository
        .getUpdateAddress(id, userId, mobile, address, city, latitude, longitude, area, type, name, countryCode, alternateCountryCode,
            alternateMobile, landmark, pincode, state, country, isDefault)
        .then((value) => emit(UpdateAddressSuccess(AddressModel(
            id: id,
            userId: userId,
            mobile: mobile,
            address: address,
