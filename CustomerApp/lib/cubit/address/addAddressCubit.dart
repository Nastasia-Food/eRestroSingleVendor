...
class AddAddressCubit extends Cubit<AddAddressState> {
  ...
  void fetchAddAddress(
    ...
    _addAddressRepository
        .getAddAddress(/* userId,  */mobile, address, city, latitude, longitude, area, type, name, countryCode, alternateCountryCode, alternateMobile,
            landmark, pincode, state, country, isDefault)
